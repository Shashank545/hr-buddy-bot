...
from utils import nonewlines, to_csv, count_tokens
from prepdocs import generate_embeddings
...
# INDEX_NAMES = ["kitchat-searchindex-pdf", "kitchat-searchindex-html"]
INDEX_NAMES = ["kitchat-searchindex-all"]
...
You are a AI assistant. Please output your response based on the following information.
Answer based on the information provided, and if there is insufficient information for your question, answer "I don't know".
"""
...
def process_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        default="data/questions_naokosan.csv",
...
def retrieve(
    *,
    ...
    if search_option in {SearchOption.Semantic, SearchOption.VectorSemantic}:
        payload = {
            **payload,
            "query_type": QueryType.SIMPLE, # need to change to QueryType.SEMANTIC
