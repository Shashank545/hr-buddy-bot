...
function x() {
  ...
  d.flush(), f.flush(e2 ? Math.min(64, r - e2) : 16.667), h.flush(), m.flush(), p.flush();
}
function l() {
...
function Lr(e2, t) {
  ...
  return o ? Boolean(t && o.inputs && it(t, o.inputs)) || (o = { inputs: t, result: e2() }) : o = r2, (0, import_react5.useEffect)(() => {
  ...
  Q2(() => {
    if (e2) {
      ...
      Ve(t, (o, s) => {
        ...
        if (a.length) {
          let i2 = n2 * e2[s];
          isNaN(i2) ? i2 = r2 : r2 = i2, Ve(a, (u4) => {
            Ve(u4.queue, (p3) => {
              let f3 = p3.delay;
              p3.delay = (d4) => i2 + I2(f3 || 0, d4);
            });
          }), o.start();
        }
      });
      ...
      Ve(t, (o) => {
        ...
        if (s.length) {
          ...
          r2 = r2.then(() => (Ve(s, (i2, u4) => Ve(a[u4] || [], (p3) => i2.queue.push(p3))), Promise.all(o.start())));
        }
      });
    }
  });
...
function De2(t, e2, n2, r2) {
  let { callId: o, parentId: s, onRest: a } = e2, { asyncTo: i2, promise: u4 } = n2;
  return !s && t === i2 && !e2.reset ? u4 : n2.promise = (async () => {
...
var ue2 = class extends X3 {
  ...
  advance(e2) {
    ...
    !i2 && Pt(o.to) && (a = ht(ve(o.to))), o.values.forEach((f3, d4) => {
      ...
      if (!b4) {
        ...
        let P2 = f3.elapsedTime += e2, l4 = o.fromValues[d4], h5 = f3.v0 != null ? f3.v0 : f3.v0 = l2.arr(s.velocity) ? s.velocity[d4] : s.velocity, g3, x4 = s.precision || (l4 == m3 ? 5e-3 : Math.min(1, Math.abs(m3 - l4) * 1e-3));
        if (l2.und(s.duration))
          if (s.decay) {
            ...
            let S2 = s.restVelocity || x4 / 10, A2 = s.clamp ? 0 : s.bounce, V3 = !l2.und(A2), _3 = l4 == m3 ? f3.v0 > 0 : l4 < m3, v5, w3 = false, C3 = 1, $3 = Math.ceil(e2 / C3);
            for (let L3 = 0; L3 < $3 && (v5 = Math.abs(g3) > S2, !(!v5 && (b4 = Math.abs(m3 - c5) <= x4, b4))); ++L3) {
              V3 && (w3 = c5 == m3 || c5 > m3 == _3, w3 && (g3 = -g3 * A2, c5 = m3));
              let N3 = -s.tension * 1e-6 * (c5 - m3), y5 = -s.friction * 1e-3 * g3, T3 = (N3 + y5) / s.mass;
              g3 = g3 + T3 * C3, c5 = c5 + g3 * C3;
            }
          }
        else {
          let S2 = 1;
          s.duration > 0 && (this._memoizedDuration !== s.duration && (this._memoizedDuration = s.duration, f3.durationProgress > 0 && (f3.elapsedTime = s.duration * f3.durationProgress, P2 = f3.elapsedTime += e2)), S2 = (s.progress || 0) + P2 / this._memoizedDuration, S2 = S2 > 1 ? 1 : S2 < 0 ? 0 : S2, f3.durationProgress = S2), c5 = l4 + s.easing(S2) * (m3 - l4), g3 = (c5 - f3.lastPosition) / e2, b4 = S2 == 1;
        }
  ...
  _update({ ...e2 }, n2) {
    ...
    e2.default && Object.assign(o, ne3(e2, (i2, u4) => /^on/.test(u4) ? et2(i2, r2) : i2)), _t(this, e2, "onProps"), Ie2(this, "onProps", e2, this);
    let s = this._prepareNode(e2);
    if (Object.isFrozen(this))
      throw Error("Cannot animate a `SpringValue` object that is frozen. Did you forget to pass your component to `animated(...)` before animating its props?");
    let a = this._state;
    return Me2(++this._lastCallId, { key: r2, props: e2, defaultProps: o, state: a, actions: { pause: () => {
      ye2(this) || (it2(this, true), yt(a.pauseQueue), Ie2(this, "onPause", E2(this, Ce2(this, this.animation.to)), this));
    }, resume: () => {
      ye2(this) && (it2(this, false), Q4(this) && this._resume(), yt(a.resumeQueue), Ie2(this, "onResume", E2(this, Ce2(this, this.animation.to)), this));
  ...
  _merge(e2, n2, r2) {
    ...
    if (o || s)
      if (n2.callId > this._lastToId)
        ...
        return r2(q2(this));
    let { key: a, defaultProps: i2, animation: u4 } = this, { to: p3, from: f3 } = u4, { to: d4 = p3, from: m3 = f3 } = e2;
    ...
    let S2 = l2.und(n2.reset) ? s && !n2.default : !l2.und(m3) && te2(n2.reset, a), A2 = S2 ? m3 : this.get(), V3 = me2(d4), _3 = l2.num(V3) || l2.arr(V3) || or(V3), v5 = !P2 && (!_3 || te2(i2.immediate || n2.immediate, a));
    if (c5) {
      let L3 = Le2(d4);
...
function at2(t, e2 = t.loop, n2 = t.to) {
  ...
  if (r2) {
    ...
    return Pe2({ ...t, loop: e2, default: false, pause: void 0, to: !s || Ee2(n2) ? n2 : void 0, from: a ? t.from : void 0, reset: a, ...o });
  }
}
function Pe2(t) {
...
async function wt(t, e2, n2) {
  let { keys: r2, to: o, from: s, loop: a, onRest: i2, onResolve: u4 } = e2, p3 = l2.obj(e2.default) && e2.default;
  a && (e2.loop = false), o === false && (e2.to = null), s === false && (e2.from = null);
  ...
  (f3 || b4 && d4.asyncId) && m3.push(Me2(++t._lastAsyncId, { props: e2, state: d4, actions: { pause: Y, resume: Y, start(P2, l4) {
    b4 ? (oe2(d4, t._lastAsyncId), l4(q2(t))) : (P2.onRest = i2, l4(De2(f3, P2, d4, t)));
...
function He2(t, e2, n2) {
  ...
  function d4(h5, g3) {
    for (let x4 = h5; x4 < g3; x4++) {
      let S2 = u4.current[x4] || (u4.current[x4] = new le2(null, i2.flush)), A2 = r2 ? r2(x4, S2) : e2[x4];
      A2 && (p3[x4] = Ot(A2));
    }
  }
...
function Qt2(t, e2, n2) {
  let r2 = l2.fun(e2) && e2;
  r2 && !n2 && (n2 = []);
  let o = true, s, a = He2(t, (i2, u4) => {
    let p3 = r2 ? r2(i2, u4) : e2;
    return s = p3.ref, o = o && p3.reverse, p3;
  }, n2 || [{}]);
  if (Q2(() => {
    Ve(a[1].current, (i2, u4) => {
      let p3 = a[1].current[u4 + (o ? 1 : -1)];
      if (he2(i2, s), i2.ref) {
        p3 && i2.update({ to: p3.springs });
        return;
      }
      p3 ? i2.start({ to: p3.springs }) : i2.start();
    });
  }, n2), r2 || arguments.length == 3) {
    let i2 = s ?? a[1];
    return i2._getProps = (u4, p3, f3) => {
      let d4 = l2.fun(u4) ? u4(f3, p3) : u4;
      if (d4) {
        let m3 = i2.current[f3 + (d4.reverse ? 1 : -1)];
...
function Gt2(t, e2, n2) {
  let r2 = l2.fun(e2) && e2, { reset: o, sort: s, trail: a = 0, expires: i2 = true, exitBeforeEnter: u4 = false, onDestroyed: p3, ref: f3, config: d4 } = r2 ? r2() : e2, m3 = (0, import_react13.useMemo)(() => r2 || arguments.length == 3 ? fe2() : void 0, []), b4 = ht(t), c5 = [], P2 = (0, import_react13.useRef)(null), l4 = o ? null : P2.current;
  Q2(() => {
    P2.current = c5;
  }), $r(() => (Ve(c5, (y5) => {
  ...
  let S2 = -a, A2 = Mr(), V3 = ne3(e2), _3 = /* @__PURE__ */ new Map(), v5 = (0, import_react13.useRef)(/* @__PURE__ */ new Map()), w3 = (0, import_react13.useRef)(false);
  Ve(c5, (y5, T3) => {
...
var hs = ({ container: t, ...e2 } = {}) => {
  ...
  return Q2(() => {
    let o = yr(({ x: s, y: a }) => {
      r2.start({ scrollX: s.current, scrollXProgress: s.progress, scrollY: a.current, scrollYProgress: a.progress });
...
var Ps = ({ container: t, ...e2 }) => {
  ...
  return Q2(() => {
    let o = ke(({ width: s, height: a }) => {
      r2.start({ width: s, height: a, immediate: n2.width.get() === 0 || n2.height.get() === 0 });
    }, { container: (t == null ? void 0 : t.current) || void 0 });
    return () => {
      Ve(Object.values(n2), (s) => s.stop()), o();
    };
...
var cr = { any: 0, all: 1 };
function Cs(t, e2) {
  let [n2, r2] = (0, import_react14.useState)(false), o = (0, import_react14.useRef)(), s = l2.fun(t) && t, a = s ? s() : {}, { to: i2 = {}, from: u4 = {}, ...p3 } = a, f3 = s ? e2 : t, [d4, m3] = J2(() => ({ from: u4, ...p3 }), []);
  return Q2(() => {
    let b4 = o.current, { root: c5, once: P2, amount: l4 = "any", ...h5 } = f3 ?? {};
    if (!b4 || P2 && n2 || typeof IntersectionObserver > "u")
      return;
    let g3 = /* @__PURE__ */ new WeakMap(), x4 = () => (i2 && m3.start(i2), r2(true), P2 ? void 0 : () => {
      u4 && m3.start(u4), r2(false);
    }), S2 = (V3) => {
      V3.forEach((_3) => {
        let v5 = g3.get(_3.target);
        if (_3.isIntersecting !== Boolean(v5))
